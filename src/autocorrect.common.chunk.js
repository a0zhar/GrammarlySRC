(self.webpackChunk = self.webpackChunk || []).push([
  ...
  {
    25703: (e, t, r) => {
      r.r(t), r.d(t, { AutocorrectUndoCard: () => C });
      var n = r(27378),
        a = r(20855),
        l = r(46547),
        i = r(88326),
      ...
      const L = () =>
        ...
        m = (e) =>
          n.createElement(
            a.u,
            { message: e.text, showDelay: 500 },
            n.createElement("div", null, e.children)
          ),
        C = (e) => {
          const t = [
              ...(e.showDisableButtons
                ? [
                    n.createElement(
                      "div",
                      { className: h.listItem, key: "disableOnce" },
                      n.createElement(
                        i.M,
                        { clickHandler: () => e.onDisableOnTabClick() },
                        n.createElement(
                          "div",
                          { ...(0, s.Sh)(h.buttonWrap) },
                          n.createElement(
                    ...
                    n.createElement(
                      "div",
                      { className: h.listItem, key: "disableAlways" },
                      n.createElement(
                        i.M,
                        { clickHandler: () => e.onDisableForeverClick() },
                        n.createElement(
                          "div",
                          { ...(0, s.Sh)(h.buttonWrap) },
                          n.createElement(
                            ...
                            n.createElement(
                              ...
                              n.createElement("path", {
                                d: "M8 1V9.29231M11.5 3.1355C13.5923 4.36445 15 6.66146 15 9.29231C15 13.2178 11.866 16.4 8 16.4C4.13401 16.4 1 13.2178 1 9.29231C1 6.66146 2.40769 4.36445 4.5 3.1355",
                                stroke: "#6D758D",
            ...
            C = () =>
              n.createElement(
                "div",
                { className: h.buttonRow, key: "buttons" },
                n.createElement(
                  i.M,
                  { clickHandler: () => e.onAcceptClick() },
                  n.createElement(
                    "div",
                    { ...(0, s.Sh)(h.button, h.acceptButton) },
                    "Looks good"
                  )
                ),
                n.createElement(
                  ...
                  n.createElement(
                    "div",
                    { ...(0, s.Sh)(h.button, h.rejectButton) },
                    "Change back to ",
                    n.createElement(
                      "span",
                      { className: h.originalText },
                      e.originalText
                    )
                  )
                )
              ...
              n.createElement(
                () =>
                  n.createElement(
                    ...
                    n.createElement(
                      "div",
                      { className: h.footerCaption },
                      "Autocorrected by Grammarly",
                      r &&
                        n.createElement(
                          i.M,
                          { clickHandler: () => a.modify((e) => !e) },
                          n.createElement(
                            "div",
                            { className: h.settingsButton },
                            n.createElement(
                              m,
                              { text: "Grammarly Autocorrect settings" },
    ...
    64578: (e, t, r) => {
      r.r(t), r.d(t, { AutocorrectAndBulkAcceptHighlights: () => L });
      var n = r(27378),
        a = r(32281),
        l = r(41703),
        i = r(5872),
        ...
        componentDidMount() {
          this._sub && this._sub.unsubscribe(),
            (this._sub = this.props.isHovered.subscribe((e) => {
              this.state.hovered !== e && this.setState({ hovered: e });
            }));
        }
                ...
                this.props.rects.map((e, t) =>
                  n.createElement("div", {
                    ...
                    style: {
                      ...
                      left: e.left,
                      width: e.width,
                      height: Math.max(0, e.height + this.props.heightOffset),
                    },
                    "data-grammarly-part": "autocorrectHighlight",
                    className: (0, i.cs)(
                      o.autocorrectHighlight,
                      o.autocorrectApplied,
      ...
      const L = ({
        ...
        getAlertById: r,
        getHoverState: i,
        autoCorrectEnabled: o,
        bulkAcceptEnabled: L,
      }) =>
        n.createElement(l.J, {
          key: "autocorrect-highlights",
          highlights: e.view((e) =>
            Array.from(e.values()).filter((e) => {
              const t = r(e.meta.alertId);
              return (
                !!t &&
                ((a.S.isAutocorrectAlert(t) && o) ||
                  (a.S.isBulkAcceptAlert(t) && L))
              );
            })
          ),
          highlightHeightOffset: t,
          ...
          highlightRenderer: (e, t, r) =>
            n.createElement(h, {
              rects: e.rects,
              heightOffset: r,
              isHovered: t.pipe(s.U((e) => e === c.pc.hovered)),
    ...
    37147: (e) => {
      e.exports = {
        autocorrectCard: "PpGBD",
        divider: "MhjgC",
        footerCaption: "_2eOqs",
        settingsButton: "_3iKhn",
        buttonRow: "oFvTm",
        button: "_3Gaqf",
        acceptButton: "_2CRGW",
        rejectButton: "mABfx",
    ...
    914: (e) => {
      e.exports = {
        autocorrectApplied: "_3L_UK",
        hovered: "_3gDtk",
        autocorrectHighlight: "_3ez9E",
        highlightFadeOut: "_12qCe",
        fadeInOutUnderline: "_1-UTk",
        undoIcon: "_27ewW",
      };
    },
  },
