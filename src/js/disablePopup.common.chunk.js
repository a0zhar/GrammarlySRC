          ...
          return l.createElement(
            "div",
            {
              className: (0, a.cs)(
                ...
                this.props.isFlipped && r.flipped
              ),
            },
            l.createElement(
              "p",
              ...
              " for ",
              l.createElement("span", { className: r.bold }, this.props.domain),
              "?"
            ),
            ...
            l.createElement(
              s.M,
              { clickHandler: () => this.cancel() },
              l.createElement("button", { className: r.close })
            )
          );
        }
      }
    ...
    7417: (e, t, n) => {
      ...
      const r = ({ className: e }) =>
        s.createElement(
          ...
          s.createElement("div", { className: "gr_-bounce1" }),
          s.createElement("div", { className: "gr_-bounce2" }),
          s.createElement("div", { className: "gr_-bounce3" })
        );
      class i extends s.Component {
        ...
        render() {
          const { loading: e, cls: t } = this.props,
            n = e ? "" : this.props.text,
            i = this.props.styles || { width: 290 },
            c = (0, a.cs)({
              [l.buttonContainer]: true,
              [l[t]]: void 0 !== t,
              [l.loading]: e,
            });
          return s.createElement(
            "div",
            { className: c, style: i },
            e && s.createElement(r, { className: l.buttonSpinner }),
            s.createElement(
              o.M,
              {
              ...
              s.createElement(
                "button",
                { type: "button", style: i, className: l.button },
                n
              )
            )
          );
